...
\item {\tt F82A} --- {\tt MYCODE} ( -- $C$), returns the {\emCell\/}~$C$ with the inital code of the smartcontract. Equivalent to {\tt GETPARAM 10}.
...
\item {\tt F944} --- {\tt FIND_BY_INIT_CODE_HASH} ($s$ -- $t$), returns the list of accounts with initial code hash specified in 256 bit of $s$ slice.
\item {\tt F945} --- {\tt FIND_BY_CODE_HASH} ($s$ -- $t$), returns the list of accounts with code hash specified in 256 bit of $s$ slice.
\item {\tt F946} --- {\tt FIND_BY_DATA_HASH} ($s$ -- $t$), returns the list of accounts with data hash specified in 256 bit of $s$ slice.
