...
use types::{Exception, Failure};
use executor::types::Instruction;
use std::sync::Arc;

fn unary<F>(engine: &mut Engine, name: &'static str, operation: F) -> Option<Exception> 
where 
...
pub(super) fn execute_sempty(engine: &mut Engine) -> Option<Exception> {
...
pub(super) fn execute_sdempty(engine: &mut Engine) -> Option<Exception> {
    unary(engine, "SDEMPTY", |slice| boolean!(slice.remaining_bits() == 0))
}

/// SREMPTY (s – r(s) = 0), checks whether Slice s has no refer- ences.
pub(super) fn execute_srempty (engine: &mut Engine) -> Option<Exception> {
...
pub(super) fn execute_sdfirst (engine: &mut Engine) -> Option<Exception> {
...
pub(super) fn execute_sdlexcmp(engine: &mut Engine) -> Option<Exception> {
...
pub(super) fn execute_sdeq(engine: &mut Engine) -> Option<Exception> {
...
pub(super) fn execute_sdpfx(engine: &mut Engine) -> Option<Exception> {
    common_prefix(engine, "SDPFX", |r_s1, _| boolean!(r_s1.is_none()))
}

/// SDPFXREV (s s′ – ?), checks whether s′ is a prefix of s, equivalent
/// to SWAP; SDPFX.
pub(super) fn execute_sdpfxrev(engine: &mut Engine) -> Option<Exception> {
...
pub(super) fn execute_sdppfx(engine: &mut Engine) -> Option<Exception> {
...
pub(super) fn execute_sdppfxrev(engine: &mut Engine) -> Option<Exception> {
...
pub(super) fn execute_sdsfx(engine: &mut Engine) -> Option<Exception> {
...
pub(super) fn execute_sdsfxrev(engine: &mut Engine) -> Option<Exception> {
...
pub(super) fn execute_sdpsfx(engine: &mut Engine) -> Option<Exception> {
...
pub(super) fn execute_sdpsfxrev(engine: &mut Engine) -> Option<Exception> {
...
pub(super) fn execute_sdcntlead0(engine: &mut Engine) -> Option<Exception> {
...
pub(super) fn execute_sdcntlead1(engine: &mut Engine) -> Option<Exception> {
...
pub(super) fn execute_sdcnttrail0(engine: &mut Engine) -> Option<Exception> {
...
pub(super) fn execute_sdcnttrail1(engine: &mut Engine) -> Option<Exception> {
